...
WebGLBase.prototype = {
    ...
    */
    calculateClickVector: function (x,y,object,surfaceID){
        z = object.minPoint.z;
        var g_nCanvasWidth = WebGLBase.canvas.width;
        var g_nCanvasHeight = WebGLBase.canvas.height;
    ...
    createObject3D: function(polygons, gl, texBuffer, normalsBuffer){
	...
	if(normalsBuffer != null) {
	    ...
	    newObject.normalsBuffer.buffer = normalsBuffer.values;
